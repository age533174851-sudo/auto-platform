          ...
          <Card style={{padding:14,marginBottom:12}}>
            ...
            <div style={{display:'flex',gap:6,marginBottom:8}}>
              ...
              <select value={leverage} onChange={e=>setLeverage(+e.target.value)}
                style={{flex:1,background:T.alt,color:leverage>20?T.red:leverage>5?T.ylw:T.grn,border:`1px solid ${T.border}`,borderRadius:7,padding:'8px',fontSize:12,fontWeight:800,outline:'none',textAlign:'center'}}>
                {[1,2,3,5,10,20,50,75,100,125].map(v=><option key={v} value={v}>{v}x</option>)}
              </select>
            </div>
