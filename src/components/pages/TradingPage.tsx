...
import { paperBuy, getOpenPositions, checkPaperExits, loadPaperBalance, closePaperPosition } from '@/lib/autotrade/store';
                ...
                return (
                  <div key={i} style={{background:T.alt,borderRadius:10,padding:'11px 13px',marginBottom:i<positions.length-1?8:0}}>
                    ...
                    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:6}}>
                      <button onClick={()=>{ closePaperPosition(p.asset, cur, 1); refreshPositions(); }}
                      ...
                      <button onClick={()=>{ closePaperPosition(p.asset, cur, 0.5); refreshPositions(); }}
                      ...
                      <button onClick={()=>{ closePaperPosition(p.asset, cur, 0.25); refreshPositions(); }}
