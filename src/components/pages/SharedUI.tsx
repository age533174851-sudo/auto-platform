                  ...
                  <div style={{display:'flex',alignItems:'center',gap:10}}>
                    ...
                    {logoUrl?(
                      ...
                      <div style={{width:32,height:32,borderRadius:8,background:`linear-gradient(135deg,${typeClr}CC,${typeClr}66)`,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
                        <span style={{color:'#fff',fontWeight:900,fontSize:10,fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums'}}>{r.symbol.slice(0,2)}</span>
                      </div>
                    )}
                    <div>
                      ...
                      <div style={{color:T.muted,fontSize:10,marginTop:1,fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums'}}>{r.symbol} · {r.exchange}</div>
                    </div>
                  </div>
