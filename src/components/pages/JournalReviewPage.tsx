          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap: 8, marginBottom: 10 }}>
            {metrics.bestTrade && (
              <Card style={{ background: T.grn+'10', border:`1px solid ${T.grn}30` }}>
                ...
                <div style={{ color: T.grn, fontSize: 12, fontWeight: 700, fontFamily:'monospace' }}>
            ...
            {metrics.worstTrade && (
              <Card style={{ background: T.red+'10', border:`1px solid ${T.red}30` }}>
                ...
                <div style={{ color: T.red, fontSize: 12, fontWeight: 700, fontFamily:'monospace' }}>
          ...
          <div onClick={(e) => e.stopPropagation()}
            ...
            {[
              ...
              <div key={l} style={{ display:'flex', justifyContent:'space-between',
                ...
                <span style={{ color: T.txt, fontSize: 12, fontWeight: 700, fontFamily:'monospace' }}>{v}</span>
              </div>
            ))}
            {selected.reason && (
