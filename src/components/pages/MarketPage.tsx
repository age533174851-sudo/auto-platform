                    ...
                    >
                      <div style={{ display:'flex', gap:8, alignItems:'center' }}>
                        ...
                        <div>
                          ...
                          <div style={{ color:T.muted, fontSize:9, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>{row.sym}</div>
                        </div>
                      </div>
        ...
        <>
          ...
          >
            ...
            <div style={{ marginBottom:14 }}>
              <div style={{ color:T.txt, fontSize:26, fontWeight:900, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>
