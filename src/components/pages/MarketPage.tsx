...
function MarketPage({
  ...
  let list = filter === '전체' ? prices : prices.filter(a => a.t === TYPE_MAP[filter]);
  if (search) {
                  ...
                  return (
                    ...
                    >
                      <div style={{ display:'flex', gap:8, alignItems:'center' }}>
                        ...
                        <Logo id={row.sym} size={30} clr={row.clr} name={row.nameKr} />
                        <div>
            ...
            {list.length === 0 ? (
              ...
              >
                <div style={{ display:'flex', alignItems:'center', gap:8, minWidth:0 }}>
                  <Logo id={a.id} size={34} clr={a.clr} name={a.nameKr} />
          ...
          >
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:14 }}>
              <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                <Logo id={selAsset.id} size={44} clr={selAsset.clr} name={selAsset.nameKr} />
                <div>
