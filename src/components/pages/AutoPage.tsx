...
import { Wallet, ListChecks, Trash2, RefreshCw, AlertCircle, CheckCircle2, MinusCircle, Ban, Clock, TrendingUp as TrendingUpIc, TrendingDown as TrendingDownIc } from 'lucide-react';
      ...
      <Card style={{
        ...
        <div style={{marginBottom: guard.todayLimit ? 8 : 0}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'baseline',marginBottom:4}}>
            ...
            <span style={{color: todayPnL.pnl >= 0 ? T.grn : T.red, fontWeight:900, fontSize:14, fontFamily:'monospace'}}>
      ...
      <Card style={{padding:'14px 16px',marginBottom:10, borderLeft:`3px solid ${T.acl}`}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:6}}>
          <div style={{background:T.alt,padding:'8px 10px',borderRadius:8,border:`1px solid ${T.border}`}}>
            ...
            <div style={{color:T.txt,fontWeight:800,fontSize:13,fontFamily:'monospace'}}>
          ...
          <div style={{background:balance.totalPnL>=0?T.grn+'15':T.red+'15',padding:'8px 10px',borderRadius:8,border:`1px solid ${balance.totalPnL>=0?T.grn:T.red}40`}}>
            ...
            <div style={{color:balance.totalPnL>=0?T.grn:T.red,fontWeight:800,fontSize:13,fontFamily:'monospace'}}>
          ...
          return (
            <Card key={log.id} style={{padding:'10px 12px',marginBottom:6,borderLeft:`3px solid ${sColor}`}}>
              ...
              {log.status === 'triggered' && log.filledPrice && log.filledAmount && (
                <div style={{color:T.txt,fontSize:11,fontFamily:'monospace',background:T.grn+'10',padding:'5px 8px',borderRadius:6,marginTop:4}}>
