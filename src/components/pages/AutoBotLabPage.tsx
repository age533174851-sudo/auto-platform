          ...
          <div style={{ marginTop: 14, padding:'12px 14px',
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap: 6, fontSize: 11 }}>
              <div>
                ...
                <span style={{ color: T.txt, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>{pullbackResult.currentPrice.toFixed(2)}</span>
              </div>
              <div>
                <span style={{ color: T.muted }}>MA: </span>
                <span style={{ color: T.txt, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>{pullbackResult.ma.toFixed(2)}</span>
              </div>
              <div style={{ gridColumn:'1/-1' }}>
                <span style={{ color: T.muted }}>이격도: </span>
                <span style={{ color: T.acl, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums', fontWeight: 700 }}>
          ...
          {[
            ...
            <div key={label} style={{ marginBottom: 8 }}>
              ...
              <input type="text" inputMode="decimal" value={val}
                ...
                style={{ width:'100%', boxSizing:'border-box', background: T.bg,
                  border:`1px solid ${T.border}`, borderRadius: 8, padding:'9px 12px',
                  color: T.txt, fontSize: 12, outline:'none', fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}/>
            </div>
          ))}
          ...
          <div style={{ marginTop: 14, padding:'12px 14px', background: T.alt, borderRadius: 10 }}>
            {[
              ...
              <div key={l} style={{ display:'flex', justifyContent:'space-between',
                ...
                <span style={{ color: c, fontSize: 12, fontWeight: 700, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>{v}</span>
              </div>
            ))}
            ...
            {splitPlan.map(o => (
              <div key={o.level} style={{ display:'grid', gridTemplateColumns:'40px 1fr 1fr',
                ...
                <div style={{ textAlign:'right' }}>
                  ...
                  <div style={{ color: T.acl, fontSize: 12, fontWeight: 700, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>
                    {formatKRW(o.capital)}
                  </div>
                </div>
              </div>
          ...
          <Card style={{ marginBottom: 10 }}>
            ...
            {DEFAULT_TRADING_WINDOWS.map((w, i) => (
              <div key={i} style={{ display:'flex', justifyContent:'space-between',
                ...
                <span style={{ color: T.acl, fontSize: 11, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>
              ...
              <div style={{ display:'flex', gap: 6, flexWrap:'wrap' }}>
                {[
                  ...
                  <span key={l} style={{
                    ...
                    padding:'2px 6px', fontSize: 9, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>
                    {l}: {v}
                  </span>
                ))}
              </div>
