          ...
          <Card key={p.id} style={{ marginBottom: 8, borderLeft: `3px solid ${color}` }}>
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom: 8 }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {p.sample && (
                  <div style={{ color: T.acl, fontSize: 11, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums', marginTop: 2 }}>
                    {p.sample}
                  </div>
                )}
                {p.error && (
              ...
              <div style={{ textAlign:'right', flexShrink: 0 }}>
                <div style={{ color: T.txt, fontSize: 13, fontWeight: 700, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>
