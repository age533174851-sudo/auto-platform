...
export default function BacktestPage() {
  ...
  return (
    <div style={{ paddingBottom: 100 }}>
      ...
      {/* Config */}
      <Card style={{ marginBottom: 10 }}>
        <div style={{ color: T.txt, fontWeight: 700, fontSize: 13, marginBottom: 10 }}>⚙️ 설정</div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap: 8, marginBottom: 10 }}>
          ...
          <div>
            <div style={{ color: T.muted, fontSize: 10, marginBottom: 4 }}>기간</div>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap: 8 }}>
              {[
                ...
                <div key={m.label} style={{ background: T.alt, borderRadius: 8, padding:'8px 10px' }}>
                  ...
                  <div style={{ color: m.color, fontSize: 13, fontWeight: 700, fontFamily:'monospace' }}>{m.value}</div>
                </div>
              ))}
            </div>
                  ...
                  <div key={i} style={{ padding:'8px 14px',
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display:'flex', alignItems:'center', gap: 6 }}>
                        <span style={{
                          background: t.side === 'buy' ? T.grn+'20' : T.red+'20',
                          color: t.side === 'buy' ? T.grn : T.red,
                          fontSize: 9, fontWeight: 700, padding:'2px 6px', borderRadius: 4,
                        }}>
                          {t.side === 'buy' ? '매수' : '매도'}
                        </span>
                        <span style={{ color: T.muted, fontSize: 9 }}>
                          {new Date(t.time).toLocaleDateString('ko-KR', { month:'short', day:'numeric' })}
                        </span>
                      </div>
                    ...
                    <div style={{ textAlign:'right' }}>
                      ...
                      {t.pnlPct !== undefined && (
                        <div style={{ color: (t.pnlPct ?? 0) >= 0 ? T.grn : T.red,
                          fontSize: 10, fontFamily:'monospace' }}>
                          {safePercent(t.pnlPct)}
                        </div>
                      )}
                    </div>
                  </div>
