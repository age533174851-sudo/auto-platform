                  ...
                  return (
                    <div key={i} style={{ padding:'9px 14px', borderBottom:`1px solid ${T.border}` }}>
                      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom: 3 }}>
                        ...
                        <span style={{ color: net >= 0 ? T.grn : T.red, fontSize: 12, fontWeight: 800, fontFamily:'monospace' }}>
                          {net >= 0 ? '+' : ''}{Math.round(net).toLocaleString('ko-KR')}원
                        </span>
                      </div>
                      <div style={{ display:'flex', gap: 10, flexWrap:'wrap', fontSize: 9, color: T.muted, fontFamily:'monospace' }}>
