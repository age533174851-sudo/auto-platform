      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:6,marginBottom:8}}>
        {data.btc && (
          <div style={{background:T.alt,padding:'8px 10px',borderRadius:8,border:`1px solid ${T.border}`}}>
            ...
            <div style={{color:T.txt,fontWeight:800,fontSize:13,fontFamily:'monospace'}}>${data.btc.price.toLocaleString('en-US',{maximumFractionDigits:0})}</div>
        ...
        {data.eth && (
          <div style={{background:T.alt,padding:'8px 10px',borderRadius:8,border:`1px solid ${T.border}`}}>
            ...
            <div style={{color:T.txt,fontWeight:800,fontSize:13,fontFamily:'monospace'}}>${data.eth.price.toLocaleString('en-US',{maximumFractionDigits:0})}</div>
        ...
        {data.funding && (
          <div style={{background:T.alt,padding:'8px 10px',borderRadius:8,border:`1px solid ${T.border}`}}>
            ...
            <div style={{color:Math.abs(data.funding.btc)>0.03?T.ylw:T.txt,fontWeight:800,fontSize:13,fontFamily:'monospace'}}>
