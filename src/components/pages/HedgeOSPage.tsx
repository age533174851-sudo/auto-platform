...
interface DrawdownState { daily:{used:number;limit:number}; weekly:{used:number;limit:number}; }
type KillSwitchTarget='all'|'futures'|'spot';
type BotMode='shadow'|'live'|'dca';
interface ExchangeHealth { name:string; status:'ok'|'slow'|'error'|'unknown'; latency:number; }
...
const INIT_DRAWDOWN: DrawdownState = {daily:{used:1.2,limit:3},weekly:{used:4.1,limit:10}};
