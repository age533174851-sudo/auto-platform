        ...
        <Card>
          ...
          {result.strategy.webhook && (
            <div style={{ marginTop:8, background:T.alt, borderRadius:8, padding:'8px 10px' }}>
              ...
              <div style={{ color:T.sub, fontSize:9, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums', lineHeight:1.5 }}>
            ...
            <Card>
              ...
              {majorLevels.map((l: any, i: number) => (
                <div key={i} style={{ display:'flex', justifyContent:'space-between', padding:'6px 0', borderBottom:`1px solid ${T.border}` }}>
                  ...
                  <div style={{ color:T.txt, fontSize:11, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>₩{Math.round(l.priceKRW/10000)}만</div>
                </div>
              ))}
            </Card>
          )}
