  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color:'#fff', fontSize:11, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums', minWidth:38, textAlign:'center' }}>
  ...
  return (
    <svg viewBox="0 0 400 560" width="100%" height="100%"
      ...
      <text x="50" y="67" textAnchor="middle" fill={nc}
        style={{ fontSize:18, fontWeight:900, fontFamily:'Inter,monospace',fontVariantNumeric:'tabular-nums' }}>{poster.id.toString().padStart(2,'0')}</text>
      {/* Category badge */}
