export default function TermsPage() {
  return (
    <div style={{ minHeight:'100vh', background:'var(--t-bg)', color:'var(--t-txt)', fontFamily:"'Sora',sans-serif", padding:'40px 20px' }}>
      <div style={{ maxWidth:720, margin:'0 auto' }}>
        ...
        <p style={{ color:'var(--t-sub)', fontSize:12, marginBottom:32 }}>최종 수정일: 2025년 5월 12일</p>
        {[
          ...
          <div key={s.title} style={{ marginBottom:28 }}>
            ...
            <p style={{ color:'var(--t-sub)', fontSize:13, lineHeight:1.8 }}>{s.body}</p>
          </div>
        ))}
      </div>
    </div>
