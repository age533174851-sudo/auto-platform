...
function GlobalSearch({onSelect,currency}:{onSelect:(id:string,nameKr:string,clr:string)=>void;currency:string}) {
  ...
  const MOCK_DB: SearchResultLocal[] = [
    ...
    {symbol:'INTC',name:'Intel Corp.',      nameKr:'인텔',      exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'AVGO',name:'Broadcom Inc.',    nameKr:'브로드컴',  exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'QCOM',name:'Qualcomm',         nameKr:'퀄컴',      exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'TSM', name:'Taiwan Semiconductor',nameKr:'TSMC',   exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'ARM', name:'ARM Holdings',     nameKr:'ARM',       exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'SMCI',name:'Super Micro Computer',nameKr:'슈퍼마이크로',exchange:'NASDAQ',asset_type:'stock',currency:'USD', provider:'polygon'},
    {symbol:'PLTR',name:'Palantir Technologies',nameKr:'팔란티어',exchange:'NYSE',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'PL',  name:'Planet Labs PBC', nameKr:'플래닛랩스', exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    ...
    {symbol:'PYPL',name:'PayPal Holdings',  nameKr:'페이팔',    exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    ...
    {symbol:'HOOD',name:'Robinhood Markets',nameKr:'로빈후드',  exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'SOFI',name:'SoFi Technologies',nameKr:'소파이',    exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'SQ',  name:'Block Inc.',       nameKr:'블록',      exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    ...
    {symbol:'UNH', name:'UnitedHealth Group',nameKr:'유나이티드헬스',exchange:'NYSE',asset_type:'stock',  currency:'USD', provider:'polygon'},
    {symbol:'JNJ', name:'Johnson & Johnson',nameKr:'존슨앤존슨', exchange:'NYSE',   asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'PFE', name:'Pfizer Inc.',      nameKr:'화이자',    exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'MRNA',name:'Moderna Inc.',     nameKr:'모더나',    exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'WMT', name:'Walmart Inc.',     nameKr:'월마트',    exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'COST',name:'Costco Wholesale', nameKr:'코스트코',  exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'MCD', name:"McDonald's Corp.", nameKr:'맥도날드',  exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'SBUX',name:'Starbucks Corp.',  nameKr:'스타벅스',  exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'KO',  name:'Coca-Cola Co.',    nameKr:'코카콜라',  exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'PEP', name:'PepsiCo Inc.',     nameKr:'펩시코',    exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'NKE', name:'Nike Inc.',        nameKr:'나이키',    exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'NFLX',name:'Netflix Inc.',     nameKr:'넷플릭스',  exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'DIS', name:'Walt Disney Co.',  nameKr:'디즈니',    exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'BA',  name:'Boeing Co.',       nameKr:'보잉',      exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'LMT', name:'Lockheed Martin',  nameKr:'록히드마틴', exchange:'NYSE',   asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'RTX', name:'RTX Corporation',  nameKr:'레이시온',  exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'RIVN',name:'Rivian Automotive',nameKr:'리비안',    exchange:'NASDAQ',  asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'NIO', name:'NIO Inc.',         nameKr:'니오',      exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'GME', name:'GameStop Corp.',   nameKr:'게임스탑',  exchange:'NYSE',    asset_type:'stock',   currency:'USD', provider:'polygon'},
    {symbol:'MSTR',name:'MicroStrategy Inc.',nameKr:'마이크로스트레티지',exchange:'NASDAQ',asset_type:'stock',currency:'USD',provider:'polygon'},
    {symbol:'SPY', name:'SPDR S&P 500 ETF', nameKr:'S&P500 ETF',exchange:'AMEX',   asset_type:'etf',     currency:'USD', provider:'polygon'},
    {symbol:'QQQ', name:'Invesco QQQ Trust',nameKr:'나스닥100 ETF',exchange:'NASDAQ',asset_type:'etf',   currency:'USD', provider:'polygon'},
    {symbol:'IWM', name:'iShares Russell 2000',nameKr:'러셀2000 ETF',exchange:'AMEX',asset_type:'etf',   currency:'USD', provider:'polygon'},
    {symbol:'DIA', name:'SPDR Dow Jones ETF',nameKr:'다우존스 ETF',exchange:'AMEX', asset_type:'etf',    currency:'USD', provider:'polygon'},
    {symbol:'TQQQ',name:'ProShares UltraPro QQQ',nameKr:'나스닥3배',exchange:'NASDAQ',asset_type:'etf', currency:'USD', provider:'polygon'},
    ...
    {symbol:'SOXL',name:'Direxion Daily Semiconductors 3x',nameKr:'반도체3배',exchange:'AMEX',asset_type:'etf',currency:'USD',provider:'polygon'},
    ...
    {symbol:'ARKK',name:'ARK Innovation ETF',nameKr:'ARK이노베이션',exchange:'AMEX',asset_type:'etf',    currency:'USD', provider:'polygon'},
    {symbol:'GLD', name:'SPDR Gold Shares', nameKr:'금 ETF',    exchange:'AMEX',    asset_type:'etf',     currency:'USD', provider:'polygon'},
    ...
    {symbol:'035420',name:'NAVER Corp.',    nameKr:'NAVER',     exchange:'KRX',     asset_type:'krstock', currency:'KRW', provider:'kis'},
    ...
    {symbol:'000270',name:'Kia Corp.',      nameKr:'기아',      exchange:'KRX',     asset_type:'krstock', currency:'KRW', provider:'kis'},
    ...
    {symbol:'USOIL', name:'WTI Crude Oil',  nameKr:'WTI 원유',  exchange:'NYMEX',   asset_type:'commodity',currency:'USD',provider:'commodity_api'},
    {symbol:'EURUSD',name:'Euro/US Dollar', nameKr:'유로/달러', exchange:'FOREX',   asset_type:'forex',   currency:'USD', provider:'exchangerate'},
    {symbol:'USDJPY',name:'US Dollar/Yen',  nameKr:'달러/엔',   exchange:'FOREX',   asset_type:'forex',   currency:'JPY', provider:'exchangerate'},
    {symbol:'USDKRW',name:'US Dollar/KRW',  nameKr:'달러/원화', exchange:'FOREX',   asset_type:'forex',   currency:'KRW', provider:'exchangerate'},
    {symbol:'GBPUSD',name:'British Pound/USD',nameKr:'파운드/달러',exchange:'FOREX', asset_type:'forex',  currency:'USD', provider:'exchangerate'},
    {symbol:'DXY',   name:'US Dollar Index',nameKr:'달러인덱스', exchange:'TVC',    asset_type:'index',   currency:'USD', provider:'mock'},
    {symbol:'SPX',   name:'S&P 500 Index',  nameKr:'S&P 500',  exchange:'SP',      asset_type:'index',   currency:'USD', provider:'mock'},
    {symbol:'NDX',   name:'NASDAQ 100',     nameKr:'나스닥100', exchange:'NASDAQ',  asset_type:'index',   currency:'USD', provider:'mock'},
    {symbol:'DJI',   name:'Dow Jones',      nameKr:'다우존스',  exchange:'DJ',      asset_type:'index',   currency:'USD', provider:'mock'},
    {symbol:'VIX',   name:'CBOE Volatility',nameKr:'공포지수',  exchange:'TVC',     asset_type:'index',   currency:'USD', provider:'mock'},
  ];
...
function TradingPage({prices,currency}:{prices:Asset[];currency:string}) {
  ...
  useEffect(()=>{
    ...
    setPwaOffline(!navigator.onLine);
    ...
    const handlePrompt=(e:Event)=>{
      ...
      // Show banner after 10s if not installed
      setTimeout(()=>{
    ...
    window.addEventListener('appinstalled',()=>{setPwaInstallable(false);setShowInstallBanner(false);setPwaPrompt(null);});
    return()=>{
  ...
  const promptPwaInstall=async()=>{
    ...
    setPwaPrompt(null); setPwaInstallable(false); setShowInstallBanner(false);
  };
...
function HedgeOSPage() {
  ...
  const totalBalance = MOCK_WALLET.reduce((s,w)=>s+w.balance,0);
  const totalUSDT    = MOCK_WALLET.reduce((s,w)=>s+w.usdtEq,0);
...
function InlineTVChart({ symbol, chartType='1', interval='60' }: { symbol:string; chartType?:string; interval?:string }) {
  ...
  useEffect(() => {
    ...
    // If widget already exists and only chartType/interval changed — update in place
    if (wid.current && wid.current.activeChart) {
      try {
        wid.current.activeChart().setChartType(TV_STYLE_MAP[chartType] ?? 1);
        wid.current.activeChart().setResolution(interval || '60', ()=>{});
        return;
      } catch {}
    }
    ...
    <div>
      ...
      <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:10,padding:'10px 14px',marginBottom:8}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:5}}>
          ...
          <div style={{display:'flex',gap:6}}>
            {[{n:'Binance',s:'live'},{n:'CoinGecko',s:'live'},{n:'Polygon',s:'unconfigured'}].map(p=>(
...
/* ─── Analysis Tab ─── */
type AnalysisTab = 'hub'|'drawing'|'interval'|'indicators'|'info'|'paper';
...
function AnalysisHubPage() {
  ...
  const [chartType,setChartType]     = useState(()=>{ try{return localStorage.getItem('tg_charttype')||'1';}catch{return '1';} });
  ...
  const [sheetContent,setSheetContent] = useState<'drawing'|'interval'|'charttype'|'objecttree'|'style'|'risk'|'fib'>('drawing');
  ...
  return (
    <div>
      ...
      <div style={{display:'flex',gap:4,marginBottom:12,overflowX:'auto'}}>
        {([['hub','🏠 허브'],['drawing','✏️ 드로잉'],['interval','⏱ 인터벌'],['indicators','🔬 지표'],['info','ℹ️ 정보'],['paper','🎮 모의']] as const).map(([id,l])=>(
      ...
      {tab==='hub'&&(
        <div>
          {/* Chart */}
          <div style={{height:'min(360px,50vw)',borderRadius:14,overflow:'hidden',border:`1px solid ${T.border}`,marginBottom:12,background:T.card,position:'relative'}}>
            <InlineTVChart symbol={symbol} chartType={chartType} interval={activeInterval}/>
          ...
          <Card style={{padding:'14px 16px',marginBottom:10}}>
            ...
            {showSaveLayout&&(
              <div style={{display:'flex',gap:6,marginBottom:10}}>
                <input value={newLayoutName} onChange={e=>setNewLayoutName(e.target.value)} onKeyDown={e=>e.key==='Enter'&&saveCurrentLayout()} placeholder="레이아웃 이름" style={{flex:1,background:T.bg,border:`1px solid ${T.acl}`,borderRadius:8,padding:'8px 10px',color:T.txt,fontSize:12,outline:'none'}}/>
            ...
            {layouts.length===0?(
              <div style={{color:T.muted,fontSize:11,textAlign:'center',padding:'12px 0'}}>저장된 레이아웃 없음</div>
            ):(
          ...
          <Card style={{padding:'14px 16px',marginBottom:10}}>
            <div style={{color:T.txt,fontWeight:700,marginBottom:8}}>📊 차트 유형 ({CHART_TYPES.find(c=>c.id===chartType)?.label})</div>
            <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:5}}>
              {CHART_TYPES.slice(0,10).map(ct=>(
                <button key={ct.id} onClick={()=>setChartType(ct.id)} style={{background:chartType===ct.id?T.acg:T.alt,border:`2px solid ${chartType===ct.id?T.acl:T.border}`,borderRadius:9,padding:'8px 4px',cursor:'pointer',textAlign:'center'}}>
                  <div style={{fontSize:16,marginBottom:2}}>{ct.icon}</div>
                  <div style={{color:chartType===ct.id?T.acl:T.muted,fontSize:7,fontWeight:700,lineHeight:1.2}}>{ct.label.slice(0,5)}</div>
                </button>
              ))}
            </div>
            <button onClick={()=>openSheet('charttype')} style={{width:'100%',marginTop:6,padding:'6px',background:'transparent',color:T.muted,border:`1px solid ${T.border}`,borderRadius:8,fontSize:10,cursor:'pointer'}}>모든 차트 유형 보기 ({CHART_TYPES.length}개) →</button>
          </Card>
          ...
          {drawings.length>0&&(
            <Card style={{padding:'12px 14px'}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:8}}>
                <div style={{color:T.txt,fontWeight:700}}>✏️ 활성 드로잉 ({visibleDrawings.length}/{drawings.length}개)</div>
                <button onClick={clearAllDrawings} style={{background:T.red+'15',color:T.red,border:'none',borderRadius:7,padding:'3px 8px',fontSize:10,cursor:'pointer'}}>전체 삭제</button>
              </div>
              {drawings.slice(0,3).map(d=>(
                <div key={d.id} style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'5px 0',borderBottom:`1px solid ${T.border}`,opacity:d.hidden?0.4:1}}>
                  <div style={{display:'flex',gap:6,alignItems:'center'}}>
                    <div style={{width:10,height:10,borderRadius:2,background:d.style.color,flexShrink:0}}/>
                    <div style={{color:T.txt,fontSize:11}}>{d.name||d.toolLabel}</div>
                    {d.locked&&<span style={{color:T.muted,fontSize:9}}>🔒</span>}
                  </div>
                  <div style={{display:'flex',gap:3}}>
                    <button onClick={()=>toggleVisible(d.id)} style={{background:'transparent',border:'none',color:T.muted,cursor:'pointer',fontSize:11}}>{d.hidden?'🙈':'👁'}</button>
                    <button onClick={()=>deleteDrawing(d.id)} style={{background:'transparent',border:'none',color:T.red,cursor:'pointer',fontSize:11}}>✕</button>
                  </div>
                </div>
              ))}
              {drawings.length>3&&<button onClick={()=>openSheet('objecttree')} style={{width:'100%',marginTop:6,background:'transparent',color:T.acl,border:`1px solid ${T.acl}30`,borderRadius:7,padding:'5px',fontSize:10,cursor:'pointer'}}>전체 보기 ({drawings.length}개) →</button>}
            </Card>
          )}
        </div>
      )}
...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="aw" style={{background:T.bg,minHeight:'100vh',minHeight:'-webkit-fill-available' as any,color:T.txt,maxWidth:480,margin:'0 auto'}}>
        ...
        <div className="mc" style={{flex:1}}>
          ...
          {/* Page Content */}
          <div style={{padding:'12px 12px var(--nav-h)'}}>{renderPage()}</div>
