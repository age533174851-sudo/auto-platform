...
const MTABS: { id: string; label: string; Icon: IconComp }[] = [
  ...
  {id:'strategies',   label:'전략빌더',   Icon: Sparkles},
  {id:'risk_settings',label:'리스크관리', Icon: Shield},
  ...
  {id:'manual_accounts', label:'수동자산등록', Icon: Wallet},
    ...
    <>
      ...
      <div suppressHydrationWarning className="aw" style={{background:T.bg,minHeight:'-webkit-fill-available' as any,color:T.txt,maxWidth:480,margin:'0 auto'}}>
        ...
        <div className="rp" style={{display:'none'}}>
          ...
          <div style={{marginTop:16,fontWeight:800,fontSize:13,color:T.txt,marginBottom:10,display:'flex',alignItems:'center',gap:6}}><Newspaper size={14} strokeWidth={2.2}/> 뉴스</div>
