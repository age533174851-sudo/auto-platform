...
export default function App() {
  ...
  const renderPage=useCallback(()=>{
    ...
    try {
      switch(tab) {
        ...
        case 'market':       return <MarketPageComp prices={prices} onNav={nav} currency={currency} onOpenAsset={openAsset}/>;
        case 'trading':      return <TradingPageComp key={activeAsset?.id||'trading'} prices={prices} currency={currency} activeAsset={activeAsset}/>;
  ...
  },[tab,prices,nav,currency,lang,setLang,setCurrency,isAdminUser,activeAsset,openAsset]);
