...
export const MIGRATION_MANIFEST: ManifestEntry[] = [
  ...
  { name: '022_rls_worker_tables.sql', id: 22, risk: 'ADDITIVE', checksum: '1b3c51365bf1e2f9' },
  ...
  { name: '067_kill_switch_effective_mode.sql', id: 67, risk: 'ADDITIVE', checksum: '5b3f9cc673658020' },
];
